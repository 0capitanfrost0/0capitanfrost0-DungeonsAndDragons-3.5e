  ...
  return (
    <div className="InitialPage-container">
        ...
        <div>
            ...
            <h4 className="txt">Recopila historias de tus aventuras, gestiona tus personajes y las criaturas del camino.
                                <br/><br/>
        ...
        <div>
            <button className="botonInicio" style={{ marginRight: 10 }}>Iniciar Sesión</button>
            <button className="botonInicio" style={{ marginRight: 10 }}>Registrarse</button>
